...
function Welcomepage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-light/50 via-white to-brand-light/30 flex flex-col font-sans overflow-x-hidden">
      ...
      {/* Navigation Header */}
      <header className="px-6 py-4 max-w-7xl mx-auto w-full flex justify-between items-center z-10">
        ...
        <button
          ...
          className="text-sm font-semibold text-slate-600 hover:text-brand-accent transition-colors py-1.5 px-4 rounded-xl border border-slate-200 bg-white hover:border-slate-300 shadow-sm cursor-pointer"
        >
          Sign In
        </button>
      </header>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-6 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex justify-center items-center relative order-2 lg:order-1">
          ...
          {/* Decorative Background Elements mirroring the user's sample style */}
          <div className="absolute top-4 left-10 w-4 h-4 rounded-full bg-brand-accent opacity-80 animate-ping-slow"></div>
          <div className="absolute bottom-10 right-10 w-6 h-6 rounded-full bg-brand-primary/40 opacity-60 animate-bounce-slow"></div>
          <div className="absolute top-1/2 left-0 w-8 h-8 rounded-full bg-brand-accent/20 blur-md"></div>

          {/* Main Illustration Wrapper */}
          <div className="relative w-full max-w-lg lg:max-w-xl bg-brand-light/20 rounded-3xl p-4 border border-brand-highlight/20 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center text-left order-1 lg:order-2 space-y-6">

          <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full bg-brand-light border border-brand-highlight/35 text-brand-accent text-xs font-semibold w-fit">
          ...
          <div className="grid grid-cols-3 gap-4 pt-2">
            <div className="flex items-center space-x-2">
              <div className="p-2 bg-brand-light text-brand-accent rounded-lg shrink-0">
                <Compass className="w-4 h-4" />
              </div>
              <span className="text-xs font-semibold text-slate-700">Explore</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="p-2 bg-brand-light text-brand-primary rounded-lg shrink-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-semibold text-slate-700">Clubs</span>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center gap-4 pt-4">
            <button
              ...
              className="flex-1 sm:flex-initial flex items-center justify-center py-3 px-6 rounded-xl text-sm font-semibold text-white bg-brand-accent hover:bg-brand-accent/90 shadow-md shadow-brand-highlight/20 transition-all cursor-pointer group"
            >
              Get Started
            ...
            <button
              onClick={() => navigate('/login')}
              className="flex-1 sm:flex-initial flex items-center justify-center py-3 px-6 rounded-xl text-sm font-semibold text-white bg-brand-primary hover:bg-brand-primary/90 shadow-md shadow-brand-primary/20 transition-all cursor-pointer"
            >
              Sign In
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-100/80 bg-white/60 backdrop-blur-sm px-6 py-5">
